...
from ms_recognizers_number.resources.portuguese_numeric import PortugueseNumeric
from ms_recognizers_number.number.extractors import ReVal, ReRe, BaseNumberExtractor, BasePercentageExtractor
