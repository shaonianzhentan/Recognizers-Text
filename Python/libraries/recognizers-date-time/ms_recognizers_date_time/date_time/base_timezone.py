...
from ms_recognizers_text import ExtractResult, RegExpUtility, QueryProcessor
from ms_recognizers_text.matcher.string_matcher import StringMatcher
...
class BaseTimeZoneParser(DateTimeParser):
    ...
    def parse(self, extract_result: ExtractResult, ref_date: datetime = None) -> DateTimeParseResult:
        ...
        elif normalized_text in TimeZoneDefinitions.AbbrToMinMapping and\
                TimeZoneDefinitions.AbbrToMinMapping[normalized_text] != Constants.INVALID_OFFSET_VALUE:
        ...
        elif normalized_text in TimeZoneDefinitions.FullToMinMapping and\
                TimeZoneDefinitions.FullToMinMapping[normalized_text] != Constants.INVALID_OFFSET_VALUE:
