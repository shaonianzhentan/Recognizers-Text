...
from ms_recognizers_date_time.date_time.abstract_year_extractor import AbstractYearExtractor
from datedelta import datedelta
from ms_recognizers_text.extractor import ExtractResult
from ms_recognizers_text.utilities import RegExpUtility, flatten
from ms_recognizers_number.number import Constants as NumberConstants
...
class BaseDateExtractor(DateTimeExtractor, AbstractYearExtractor):
    ...
    def extract_in_connector(self, text, first_str, second_str, duration, in_prefix):
        from ms_recognizers_date_time import Token
        result = []
