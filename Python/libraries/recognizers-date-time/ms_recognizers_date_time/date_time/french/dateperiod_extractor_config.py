...
from ms_recognizers_number.number.french.extractors import FrenchIntegerExtractor, FrenchCardinalExtractor
...
from ms_recognizers_number import FrenchOrdinalExtractor, BaseNumberExtractor, FrenchCardinalExtractor
