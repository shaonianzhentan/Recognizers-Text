...
from ms_recognizers_number import GermanIntegerExtractor
...
class GermanMergedExtractorConfiguration(MergedExtractorConfiguration):
    ...
    def __init__(self):
        ...
        self._ambiguity_filters_dict = DefinitionLoader.load_ambiguity_filters(GermanDateTime.AmbiguityFiltersDict)
